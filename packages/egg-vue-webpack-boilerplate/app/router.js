...
module.exports = (app) => {
  ...
  router.get("/api/getBillList", app.controller.bill.index.getBillList)
  router.get("/api/getBillCateList", app.controller.bill.index.getBillCateList)
  router.post("/bill/api/addBill", app.controller.bill.index.addBill)
}
